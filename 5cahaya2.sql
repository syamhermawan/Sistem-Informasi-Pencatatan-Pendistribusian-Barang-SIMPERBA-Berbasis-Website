...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 04, 2024 at 05:49 PM
...
INSERT INTO `barang` (`kode_brg`, `nama_brg`, `ukuran`, `stok`, `id_kategori`, `id_satuan`, `hrgjual`, `hrgbeli`, `pemkode`, `gambar`) VALUES
('K0091', 'MINYAKITA 1L Pilow Pack', '1 Liter', 50, 1, 5, 200000, 188000, 'D0001', 'minyakita.jpg'),
('K0092', 'Lark Beauty', '80gr', 0, 3, 5, 185000, 148000, 'D0001', 'lark_prima3.jpg');
...
(178, 'K0005', 'P0002', 'K0091', 'MINYAKITA 1L Pilow Pack', '1 Liter', 1, 5, 200000, 0, 5, 1000000),
(180, 'K0004', 'P0003', 'K0091', 'MINYAKITA 1L Pilow Pack', '1 Liter', 1, 5, 200000, 0, 10, 2000000);
...
('K0006', 'Muli', 'Jl. Pembina 9, Gg. Gustaf No 19', '085754346675');
...
('P0001', 'K0002', 'Wahyu', 'kartini', '085345678895', 2000000, 1, '2024-02-01', 1, '0'),
('P0002', 'K0005', 'Toko Sembako', 'Jl. Baamang Hulu 1', '085323458899', 1000000, 1, '2024-02-03', 2, '0'),
('P0003', 'K0004', 'Nadia', 'Jl.Waluh gg', '085467747734', 2000000, 0, '2024-02-07', 2, 'P7D');
...
(16, 'syamhermawan@gmail.com', 'syam', '$2y$10$MAX9s3kZKv8P1kd0xC7SVeh9JpeAK3fog2PnKbl9neKiwgtPtNfXS', '2', 1, 'default.jpg'),
(17, 'syam', 'hermawan', '$2y$10$.sYJoOz.B0rsus6QBpArn.J08EIhKyx5DnqnaGBRXQQZ9g1aTx/bS', '2', 1, 'default.jpg');
...
(25, 2, 'Daftar Barang', 'barang', 'fa fa-bars', 1),
