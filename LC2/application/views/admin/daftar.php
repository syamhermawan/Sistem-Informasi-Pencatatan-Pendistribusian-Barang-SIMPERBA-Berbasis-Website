                ...
                <div class="col-lg-7">
                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                        ...
                        <div class="card-body">
                            <form action="<?= base_url('admin/daftar'); ?>" method="post">
                                <div class="form-group">
                                    ...
                                    <input class="form-control py-4" id="username" name="username" type="text" placeholder="Username anda" />
                                    <div class="small mb-3 text-muted"><?= form_error('username'); ?></div>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="card-footer text-center">
                            <div class="small"><a href="<?= base_url('admin') ?>">Kembali</a></div>
                        </div>
                    </div>
                </div>
            </div>
